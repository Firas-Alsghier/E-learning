...
<template>
  <ClientOnly>
    <CustomContainer v-if="!isLoggedIn">
      ...
      >
        <!-- Top right vector -->
        <img src="/assets/images/cap.png" alt="Decoration" class="absolute top-0 right-0 w-32 sm:w-48 opacity-40 pointer-events-none select-none" />

        <!-- Bottom left vector -->
        <img src="/assets/images/letter.png" alt="Decoration" class="absolute bottom-0 left-0 w-32 sm:w-48 opacity-40 pointer-events-none select-none" />
