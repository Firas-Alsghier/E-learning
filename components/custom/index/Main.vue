  ...
  <main class="h-[90vh] max-sm:h-[70vh] relative overflow-hidden bg-gradient-to-r from-[#191501] to-[#2e8769]">
    <CustomContainer>
      ...
      <div class="flex max-sm:flex-col max-md:flex-col -400 max-sm:h-full items-center max-sm:w-full justify-between max-sm:px-20">
        ...
        <div
          class="max-sm:w-full max-md:mt-4 max-md:w-full max-md:text-center max-md:order-1 max-sm:h-full text-right w-2/4 max-sm:text-center max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center max-sm:pt-5"
        >
